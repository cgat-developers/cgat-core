...
from CGATCore.Pipeline.Utils import getCallerLocals
from CGATCore.Pipeline.Parameters import substituteParameters
from CGATCore.Pipeline.Files import getTempFilename
